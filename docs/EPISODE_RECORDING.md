...
[交互技能画廊](https://daniel-rmc.github.io/ManiLoop/?lang=zh#skills)可切换 GPT-6 官方成功回合，播放完整操作并逐步查看动作说明与上一动作反馈：

| 任务 | 模型请求 | 实际执行动作 | 控制步 | 双相机帧数 | 视频时长 |
| --- | ---: | ---: | ---: | ---: | ---: |
| 将碗放到盘子上 | 46 | 46 | 706 | 707 | 35.35 秒 |
| 打开炉具 | 27 | 25 | 447 | 448 | 22.40 秒 |
| 奶油奶酪入篮 | 29 | 29 | 390 | 391 | 19.55 秒 |

视频均为 20 fps；炉具包含两次未执行的拒绝请求，因此请求数与执行动作数不同。完整性与每次官方判定的范围见[公开结果](RESULTS.md)。
